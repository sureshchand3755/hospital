                ...
                <div class="card card-table show-entire">
                    <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="doctor-table-blk">
                                        ...
                                        <div class="doctor-search-blk">
                                            <div class="add-group">
                                                <a href="{{url('visit/add')}}" class="btn btn-primary add-pluss ms-2" title="Add"><img src="{{URL::to('public/assets/img/icons/plus.svg')}}" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 custom-table comman-table datatable mb-0" id="visit_list">
                                <thead>
                                    <tr>
                                        <th>
...
<div class="modal fade" id="view_visit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Delete  Modal -->
<div id="delete_visit" class="modal fade delete-modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                <form action="{{route('visit.delete')}}" method="POST">
                    @csrf
...
setTimeout(() => {
    ...
    var listUrl="{{ route('visit.list') }}";
    $(document).on('click','.delete_visit',function(){
        var id = $(this).data('id');
        $('#e_id').val(id);
    });

    var table = $('#visit_list').DataTable({
        processing: true,
        responsive: true,
        pageLength: 10,
