                                ...
                                <div class="col">
                                    <div class="doctor-table-blk">
                                        ...
                                        <div class="doctor-search-blk">
                                            ...
                                            <div class="add-group">
                                                <a href="{{(Auth::user()->type==2)?url('doctor/add'):url('admin/doctor/add')}}" class="btn btn-primary add-pluss ms-2" title="Add"><img src="{{URL::asset('/assets/img/icons/plus.svg')}}" alt=""></a>
