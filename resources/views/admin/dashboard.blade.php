    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    <div class="dash-boxs comman-flex-center">
                        <img src="{{URL::asset('assets/img/icons/calendar.svg')}}" alt="">
                    </div>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    <div class="dash-boxs comman-flex-center">
                        <img src="{{URL::asset('assets/img/icons/profile-add.svg')}}" alt="">
                    </div>
                    <div class="dash-content dash-count">
                        <h4>New Patients</h4>
            ...
            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                <div class="dash-widget">
                    <div class="dash-boxs comman-flex-center">
                        <img src="{{URL::asset('assets/img/icons/empty-wallet.svg')}}" alt="">
                    </div>
                    <div class="dash-content dash-count">
                        <h4>Earnings</h4>
                    ...
                    <div class="card-body">
                        <div class="activity-top">
                            <div class="activity-boxs comman-flex-center">
                                <img src="{{URL::asset('assets/img/icons/dep-icon-01.svg')}}" alt="">
                            </div>
                        ...
                        <div class="activity-top">
                            <div class="activity-boxs comman-flex-center">
                                <img src="{{URL::asset('assets/img/icons/dep-icon-02.svg')}}" alt="">
                            </div>
                            <div class="departments-list">
                                <h4>Dentist</h4>
                                <p>24%</p>
                        ...
                        <div class="activity-top">
                            <div class="activity-boxs comman-flex-center">
                                <img src="{{URL::asset('assets/img/icons/dep-icon-03.svg')}}" alt="">
                            </div>
                            <div class="departments-list">
                                <h4>ENT</h4>
                                <p>10%</p>
                        ...
                        <div class="activity-top">
                            <div class="activity-boxs comman-flex-center">
                                <img src="{{URL::asset('assets/img/icons/dep-icon-04.svg')}}" alt="">
                            </div>
                            <div class="departments-list">
                                <h4>Cardiologist</h4>
                                <p>15%</p>
                        ...
                        <div class="activity-top mb-0">
                            <div class="activity-boxs comman-flex-center">
                                <img src="{{URL::asset('assets/img/icons/dep-icon-05.svg')}}" alt="">
                            </div>
                            <div class="departments-list">
                                <h4>Opthomology</h4>
                                <p>20%</p>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="table-image appoint-doctor">
                                            <img width="28" height="28" class="rounded-circle" src="{{URL::asset('assets/img/profiles/avatar-02.jpg')}}" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-image appoint-doctor">
                                            <img width="28" height="28" class="rounded-circle" src="{{URL::asset('assets/img/profiles/avatar-03.jpg')}}" alt="">
                                    ...
                                    <tr>
                                        ...
                                        <td>Bernardo </td>
                                        <td class="table-image appoint-doctor">
                                            <img width="28" height="28" class="rounded-circle" src="{{URL::asset('assets/img/profiles/avatar-04.jpg')}}" alt="">
                                            <h2>Dr.Martin Doe</h2>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-image appoint-doctor">
                                            <img width="28" height="28" class="rounded-circle" src="{{URL::asset('assets/img/profiles/avatar-05.jpg')}}" alt="">
