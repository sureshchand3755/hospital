        ...
        <div class="doctor-list-blk">
            <div class="row">
                <div class="col-xl-3 col-md-6">
                    <div class="doctor-widget border-right-bg">
                        <div class="doctor-box-icon flex-shrink-0">
                            <img src="{{URL::to('public/assets/icons/doctor-dash-01.svg')}}" alt="">
                        </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="doctor-widget border-right-bg">
                        <div class="doctor-box-icon flex-shrink-0">
                            <img src="{{URL::to('public/assets/icons/doctor-dash-02.svg')}}" alt="">
                        </div>
                        <div class="doctor-content dash-count flex-grow-1">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="doctor-widget border-right-bg">
                        <div class="doctor-box-icon flex-shrink-0">
                            <img src="{{URL::to('public/assets/icons/doctor-dash-03.svg')}}" alt="">
                        </div>
                        <div class="doctor-content dash-count flex-grow-1">
                    ...
                    <div class="doctor-widget">
                        <div class="doctor-box-icon flex-shrink-0">
                            <img src="{{URL::to('public/assets/icons/doctor-dash-04.svg')}}" alt="">
                        </div>
                        <div class="doctor-content dash-count flex-grow-1">
            ...
            <div class="col-12 col-md-12 col-lg-6 col-xl-2 d-flex">
                <div class="struct-point">
                    <div class="card patient-structure">
                        <div class="card-body">
                            <h5>New Patients</h5>
                            <h3>56<span class="status-green"><img src="{{URL::to('public/assets/icons/sort-icon-01.svg')}}" alt="" class="me-1">60%</span></h3>
                        </div>
                    </div>
                    <div class="card patient-structure">
                        <div class="card-body">
                            <h5>Old Patients</h5>
                            <h3>35<span class="status-pink"><img src="{{URL::to('public/assets/icons/sort-icon-02.svg')}}" alt="" class="me-1">-20%</span></h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card wallet-widget">
                            <div class="circle-bar circle-bar2">
                                <div class="circle-graph2" data-percent="66">
                                    <b><img src="{{URL::to('public/assets/icons/timer.svg')}}" alt=""></b>
                                </div>
                            </div>
                                                ...
                                                <ul class="doctor-sub-list dropdown-menu">
                                                    ...
                                                    <li class="schedule-blk mb-0 pt-2 dropdown-item">
                                                        <ul class="nav schedule-time">
                                                            <li><a href="javascript:;"><img src="{{URL::to('public/assets/icons/trash.svg')}}" alt=""></a></li>
                                                            <li><a href="javascript:;"><img src="{{URL::to('public/assets/icons/profile.svg')}}" alt=""></a></li>
                                                            <li><a href="javascript:;"><img src="{{URL::to('public/assets/icons/edit.svg')}}" alt=""></a></li>
                                                        </ul>
