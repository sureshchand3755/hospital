    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{url('visit/update')}}" id="edit_visit">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <input type="text" id="visit_id" name="id" value="{{$data->id}}" style="display: none">
...
<script>
    ...
    checkUrl = checkUrl.replace(':id', id);
        $("#edit_visit").validate({
            ...
            messages: {
                name: {
                    required :"Please enter your visit name",
                    remote : "Visit Name is already exists",
                },
