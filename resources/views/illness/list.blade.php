                ...
                <div class="card card-table show-entire">
                    <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="doctor-table-blk">
                                        ...
                                        <div class="doctor-search-blk">
                                            <div class="add-group">
                                                <a href="{{url('illness/add')}}" class="btn btn-primary add-pluss ms-2" title="Add"><img src="{{URL::to('public/assets/img/icons/plus.svg')}}" alt=""></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 custom-table comman-table datatable mb-0" id="illness_list">
                                <thead>
                                    <tr>
                                        <th>
...
<!-- View Modal -->
<div class="modal fade" id="view_illness" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<!-- Delete Modal -->
<div id="delete_illness" class="modal fade delete-modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                <form action="{{route('illness.delete')}}" method="POST">
                    @csrf
...
$(document).on('click','.view_illness',function(){
    var id = $(this).data('id');
    var url = "{{ route('illness.view', ':id') }}";
...
setTimeout(() => {
    ...
    var listUrl="{{ route('illness.list') }}";

    $(document).on('click','.delete_illness',function(){
        var id = $(this).data('id');
        $('#e_id').val(id);
    });

    var table = $('#illness_list').DataTable({
        processing: true,
        responsive: true,
        pageLength: 10,
