    ...
    <div class="content">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{url('symptoms/update')}}" id="edit_symptoms">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <input type="text" id="symptoms_id" name="id" value="{{$data->id}}" style="display: none">
...
<script>
    $(function () {
    var id = $('#symptoms_id').val();
    checkUrl = "{{ route('symptoms.check', ':id') }}";
    checkUrl = checkUrl.replace(':id', id);
        $("#edit_symptoms").validate({
            rules: {
                name: {
                    required: true,
                    remote: checkUrl
            ...
            messages: {
                name: {
                    ...
                    remote : "Symptoms Name is already exists",
                },
